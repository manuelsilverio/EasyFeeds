...
public class MoviesDataSource {
	private final String PREFTITLE = "TitleMovies";
	private final String PREF_FEED_URL = "feedUrlMovies";
	private final String PREF_IMG_URL = "imgUrlMovies";
	...
	public MoviesDataSource(Context context, String key){

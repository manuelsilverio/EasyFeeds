...
public class CookingDataSource {
	private final String PREFTITLE = "TitleCooking";
	private final String PREF_FEED_URL = "feedUrlCooking";
	private final String PREF_IMG_URL = "imgUrlCooking";
	...
	public CookingDataSource(Context context, String key){
	...
	public boolean checkStored(String feedUrl){
		...
		if(titlePrefs.getString(feedUrl, null)!=null){
			result = true;
		}
		return result;
	}

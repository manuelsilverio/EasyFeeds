...
public class GamingDataSource {
	private final String PREFTITLE = "TitleGaming";
	private final String PREF_FEED_URL = "feedUrlGaming";
	private final String PREF_IMG_URL = "imgUrlGaming";
	...
	public GamingDataSource(Context context, String key){

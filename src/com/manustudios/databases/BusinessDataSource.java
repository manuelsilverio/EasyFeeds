...
public class BusinessDataSource {
	private final String PREFTITLE = "TitleBusiness";
	private final String PREF_FEED_URL = "feedUrlBusiness";
	private final String PREF_IMG_URL = "imgUrlBusiness";
	...
	public BusinessDataSource(Context context, String key){
